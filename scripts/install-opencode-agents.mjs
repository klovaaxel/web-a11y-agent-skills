...
const sourceDir = join(repoRoot, "agents", "opencode");
const targetDir =
  process.env.WEB_A11Y_AGENT_SKILLS_OPENCODE_AGENT_DIR ??
...
console.log(
  `Installed ${files.length} OpenCode accessibility subagents to ${targetDir}${
